<%-- 
    Document   : porcinos
    Created on : 7/02/2023, 04:35:17 PM
    Author     : julia
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-12">
                <h2 class="text-center py-3">Porcinos disponibles</h2>
            </div>

            <div class="row">
                <div class="col-sm-8">
                    <a href="agregar.jsp" class="btn btn-primary mb-3"><i class="bi bi-plus-circle"></i> Nuevo porcino</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <%
                        ...
                        ResultSet rs;
                        rs = conectar.Buscar("SELECT * FROM producto");
                    %>
                    <table class="table table-bordered table-striped" id="MiTabla">
                        <thead class="text-center">
                        <th>Clave</th>
                        <th>Género</th>
                        <th>Raza del porcino</th>
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td><a href="editar.jsp?cve=<%=rs.getString(1)%>" title="Actualizar datos" class="btn btn-warning btn-sm">
                                        <i class="bi bi-pencil-square"></i></a>
                                    <a href="vender.jsp?cve=<%=rs.getString(1)%>" title="Vender porcino" class="btn btn-success btn-sm">
