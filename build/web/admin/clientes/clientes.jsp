...
<html lang="es">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-12">
                <h2 class="text-center py-3">Lista de Clientes</h2>
            </div>

            <div class="row">
                <div class="col-sm-8">
                    <a href="agregar.jsp" class="btn btn-primary mb-3"><i class="bi bi-plus-circle"></i> Nuevo Cliente</a>
                </div>
                <div class="col-sm-4 d-flex flex-row-reverse">
                    <a href="reporte.jsp" class="btn btn-danger mb-3 mx-2" target="_blank"><i class="bi bi-printer-fill"></i> Reporte</a>
                    <a href="grafica.jsp" class="btn btn-success mb-3" target="_blank"><i class="bi bi-bar-chart-line-fill"></i> Ubicación de Clientes</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <%
                        ...
                        ResultSet rs;
                        rs = conectar.Buscar("SELECT rfc,tp,nom,CONCAT(app,' ',apm),tel,cor,ef,mun FROM clientes");
                    %>
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td><a href="consulta.jsp?rfc=<%=rs.getString(1)%>"
                                    ...
                                    <a href="eliminar.jsp?rfc=<%=rs.getString(1)%>" title="Eliminar cliente" class="btn btn-danger btn-sm">
