<%-- 
    Document   : agregar
    Created on : 17/04/2023, 07:15:21 PM
    Author     : Julian Angel
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="col-sm-3">
            <p class="p-3 fw-bold fs-5 text-center bg-danger bg-opacity-10 border border-danger border-start-0 rounded-end">Registrar Nuevo Alimento</p>
        </div>
        ...
        <div class="container-fluid">
            <form action="agregar.jsp" method="POST" autocomplete="off">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" name="nom" placeholder="Nombre del producto" required>
                    </div>
                    <div class="col-sm-6">
                        <label>Marca del producto:</label>
                        <input type="text" class="form-control" name="mar" placeholder="Marca del producto" required>
                    </div>
                </div> <br>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" name="uni" placeholder="Unidad de medida en KG" required>
                    </div>
                    <div class="col-sm-6">
                        <label>Precio:</label>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="number" class="form-control" name="exi" placeholder="Cantidad en existencia" required>
                    </div>
                </div> <br>
            ...
            <%
                ...
                if (request.getParameter("enviar") != null) {
                    con.CRUD("INSERT INTO alimentos (nom, mar, uni, pre, exi) VALUES ('" + nom + "','" + mar + "',"
                            + "'" + uni + "', '" + pre + "','" + exi + "')");
